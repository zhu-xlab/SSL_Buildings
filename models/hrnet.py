...
class HighResolutionNet(nn.Module):
    ...
    def get_probs(self, feat, size=None):
        logit = self.last_layer(feat)
        logit = upsample_scale(logit, scale=self.scale_factor)
    ...
    def adjust_learning_rate(self, init_lr, optimizer, iters, total_iters):
        learning_rate = init_lr * (1 - iters / total_iters) ** 0.9
